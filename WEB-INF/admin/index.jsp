...
<div id="apDiv13"><html:link action="/adminloadtransactaction.do">
...
<div class="name">
	      <div align="center" class="style3">Admin Section</div>
      </div>
<div id="Middle">
          <div id="Page">
            <div id="Content">
              <div align="center">
                  <%--
        Displays a the username of the User
        --%>
                <p align="center"><i>Welcome ${sessionScope['username']}</i></p>
              </div>
              <p class="Part">&nbsp;</p>
              <p class="Part">&nbsp;</p>
              <p class="Part">&nbsp;</p>
