...
<html:html>
    <head>
        ...
        <title>Welcome to Realtors Portal</title>
...
<div class="name">
	      <div align="center" class="style3">Welcome to Realtors Portal</div>
      </div>
<div id="Middle">
          <div id="Page">
            <div id="Content">
              <div class="Part" id="product_2">
                <p><img src="images/homeatrealtors.jpg" alt="picture" width="200" height="136" />
                    Welcome to Realtors Portal. Realtors Portal is an Online Systems for Real Estate Properties We
                provide information on all types of Real estate properties, such as office space, Shops,
                commercial land, industrial property, House, Apartments, Villas and businesses for sale, rent and lease.
                We also have positions in the organizations where users can register as either Agent or Private Sellers and also post ads .
                We look forward to getting a new Real Estate property as pleasant and Stress free as possible.</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
