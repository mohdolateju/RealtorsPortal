...
<div id="apDiv12"><html:link action="/adminloadsubpackageaction">
...
<div class="name">
	      <div align="center" class="style3">Transaction Log</div>
      </div>
<div id="Middle">
          <div id="Page">
            <div id="Content">
        ...
        --%>
                      <c:forEach items="${translog.creditCardno}" var="translogs" varStatus="status">
                      <tr>
                          <td>${translog.creditCardno[status.count-1]}</td>
                          <td>${translog.transactUsername[status.count-1]}</td>
                          <td>${translog.date[status.count-1]}</td>
                          <td>${translog.type[status.count-1]}</td>
                      </tr>
                      </c:forEach>
                  </table>
              </div>
