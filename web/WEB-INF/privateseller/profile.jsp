<%-- 
    Document   : For Private Seller Profile Management
...
<html:html>
    <head>
        ...
        <title>Manage PrivateSeller Profile</title>
...
<div id="apDiv8">
    ...
    <c:if scope="session" test="${empty username}" var="var"><html:link href="/RealtorsPortal/login.jsp">
            ...
            <img src="/RealtorsPortal/images/buttons/log_out.jpg" alt="Log out" width="192" height="44"></html:link></c:if></div>
<div id="apDiv10">
...
<div class="name">
	      <div align="center" class="style3">Manage PrivateSeller Profile</div>
      </div>
<div id="Middle">
          <div id="Page">
            <div id="Content">
        ...
        --%>
            ...
            <html:form action="/updateprofile">${requestScope['success']}</div>
    ...
    <html:form action="/psellerchangepassword">
