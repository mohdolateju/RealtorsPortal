<%-- 
    Document   : The Document Displasy All Ads Posted by the User
...
<html:html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function adddetail(){
                document.AdDetaiFormBean.submit();
...
<div class="name">
	      <div align="center" class="style3">Ads Listings</div>
      </div>
<div id="Middle">
          <div id="Page">
            <div id="Content">
                <div align="center">
                    <html:form action="/ad_detail">
                        <%--
        Displays all the information for each ad
        --%>
                    <c:forEach var="image" items="${adsbean.imagePath}" varStatus="status">
                        <div class="Part"><html:hidden value="${image}" property="name"/>
